          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2 text-xs">
                <span className="bg-green-100 text-green-800 px-2 py-1 rounded-lg font-semibold">TRENDING</span>
                <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-lg font-semibold">Beta Testing</span>
                <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-lg font-semibold">FDA Track</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3 text-xs font-semibold mb-4">
                <span className="bg-indigo-100 text-indigo-600 px-2 py-1 rounded-lg">Healthcare</span>
                <span className="bg-green-100 text-green-600 px-2 py-1 rounded-lg">AI/ML</span>
                <span className="bg-pink-100 text-pink-600 px-2 py-1 rounded-lg">MedTech</span>
                <span className="bg-yellow-100 text-yellow-600 px-2 py-1 rounded-lg">Research</span>
              </div>
              ...
              <div className="bg-white mt-6 p-4 border rounded-xl shadow flex flex-col md:flex-row gap-4 items-stretch">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className="bg-blue-600 rounded-lg p-1 flex items-center justify-center">
                      <svg width="20" height="20" fill="none"><rect width="20" height="20" rx="5" fill="#fff"/><path d="M6 15v-6m4 6V6m4 9v-3" stroke="#2563eb" strokeWidth="2" strokeLinecap="round"/></svg>
                    </div>
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="bg-gray-50 rounded-lg p-3 h-full flex flex-col">
                    <div className="font-semibold text-gray-700 mb-2 text-sm">Performance Trend</div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border rounded-2xl shadow p-0 mt-6">
                <h2 className="font-bold text-base px-4 pt-4 pb-1 text-gray-700">Clinical Validation Results</h2>
                <div className="bg-white rounded-t-xl flex items-center gap-2 px-4 py-2 border-b">
                  {/* Icon */}
                  <div className="bg-blue-600 rounded-lg p-1 flex items-center justify-center">
                    <svg width="16" height="16" fill="none"><rect width="16" height="16" rx="4" fill="#fff"/><path d="M8 4v8M4 8h8" stroke="#2563eb" strokeWidth="2" strokeLinecap="round"/></svg>
                  </div>
                  <span className="font-bold text-blue-700 text-sm">Clinical Trial Results</span>
                </div>
